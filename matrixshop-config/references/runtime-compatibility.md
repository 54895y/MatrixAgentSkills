...
| --- | --- | --- | --- | --- | --- |
| `1.3.0` | `Paper` | `1.21.8` | Pass | smoke boot | plugin load, enable, and server ready state confirmed |
| `1.3.0` | `Paper` | `1.21.11` | Pass | smoke boot | plugin load, enable, and server ready state confirmed |
...
| Runtime artifact | `build/libs/MatrixShop-1.3.0-all.jar` | local `./gradlew build` result |

## Practical wording rules

- You may say `Paper 1.21.8` and `Paper 1.21.11` are currently verified for `MatrixShop 1.3.0` smoke boot.
